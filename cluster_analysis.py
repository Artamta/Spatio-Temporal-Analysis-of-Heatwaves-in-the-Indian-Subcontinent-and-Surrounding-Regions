...
plt.grid(alpha=0.3)
plt.savefig('/Users/ayush/Desktop/Final_Report/some_otherplots__/circular_space_clusters.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(alpha=0.3)
plt.savefig('/Users/ayush/Desktop/Final_Report/some_otherplots__/day_of_year_distribution.png', dpi=300, bbox_inches='tight')
plt.close()